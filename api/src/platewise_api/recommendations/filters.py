...
machine-readable :class:`~platewise_api.recommendations.enums.ExclusionReason` codes —
...
from platewise_db.enums import AllergenDeclarationType, OfferingStatus, ProvenanceSourceType

from platewise_api.recommendations.contracts import RecommendationItem, UserPreferences
from platewise_api.recommendations.enums import CautionReason, ExclusionReason, GoalType, SafetyMode
...
def evaluate_item(item: RecommendationItem, preferences: UserPreferences) -> EligibilityDecision:
