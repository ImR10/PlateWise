...
CAUTION_TEXT: dict[CautionReason, str] = {
    ...
    CautionReason.DIETARY_DATA_INCOMPLETE: (
        "Dietary information is incomplete; a required dietary tag could not be confirmed."
    ),
...
WARNING_TEXT: dict[ResultWarning, str] = {
    ResultWarning.NO_ELIGIBLE_ITEMS: ("No items met your preferences and safety settings."),
    ...
    ResultWarning.PLATE_NOT_ASSEMBLED: ("A plate could not be assembled from the eligible items."),
