...
import pytest
from platewise_db.repositories.imports import recipe_content_hash
...
def test_fixture_rejects_conflicting_hierarchy_source_system() -> None:
    payload = {
        ...
        "venues": [{"source_system": "spoofed", "name": "Other", "slug": "other"}],
    }
...
def test_recipe_source_text_participates_in_version_hash() -> None:
    ...
    from platewise_api.imports.contracts import ImportedRecipe
