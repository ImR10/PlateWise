...
from platewise_db import models  # noqa: F401  (registers all models on Base.metadata)
...
#   3. The DB package's development default.
...
if not _configured_url or _configured_url.startswith("driver://"):
    _configured_url = os.getenv("DATABASE_URL", get_database_url())
