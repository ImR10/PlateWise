...
NutrientDecimal = Annotated[
    Decimal, Field(ge=0, le=Decimal("99999999.99"), allow_inf_nan=False)
]
QuantityDecimal = Annotated[
    Decimal, Field(ge=0, le=Decimal("99999999.9999"), allow_inf_nan=False)
]
ServingDecimal = Annotated[
    Decimal, Field(ge=0, le=Decimal("9999999.999"), allow_inf_nan=False)
]
